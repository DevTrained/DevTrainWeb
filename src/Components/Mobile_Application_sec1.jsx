...
const VideoSection = () => {
  ...
  <h1 className="text-2xl px-2 sm:text-4xl mt-2 md:text-4xl lg:text-4xl  font-extrabold text-gray-800 ">Mobile Application Development Services</h1>
  <p className="text-gray-700 font-medium pt-4 px-3">
  "Devtrain.co offers end-to-end mobile application services, creating customized, user-friendly apps tailored to meet your business needs. Our team ensures seamless functionality and top-notch performance across all mobile platforms."
  </p>
</div>
