...
const VideoSection = () => {
  ...
  return (
    ...
    <section className="flex flex-col md:flex-row items-center justify-between py-12 px-4 bg-[#def2f1] font-poppins ">
      ...
      <img 
    src="/public/Assets/Images/Sementic_Seo.webp" 
    alt="AI Consultancy" 
  ...
  <h1 className="text-2xl px-2 sm:text-4xl mt-2 md:text-4xl lg:text-4xl  font-extrabold text-gray-800 ">Sementic SEO Services</h1>
  <p className="text-gray-700 font-medium pt-4 px-3">
  With our semantic SEO service, Devtrain.co enhances search engine understanding of your content, ensuring it reaches the right audience effectively. We focus on context-driven strategies that improve relevance, visibility, and long-term search rankings.
  </p>
</div>
