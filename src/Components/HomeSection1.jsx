...
const HomeSection = () => {
  ...
  <div className="flex flex-row items-center justify-center pt-12 sm:pt-16 md:pt-0 lg:pt-0 xl:pt-0 gap-2">
    {/* Left Line */}
    <div className="h-1 w-6 md:w-10 lg:w-20 bg-[#089084]" data-aos="fade-up"></div>

    {/* Text */}
    <h1 className="text-md sm:text-xl md:text-md lg:text-xl font-bold text-[#089084] whitespace-nowrap" data-aos="fade-up">
  ...
  <div className="w-full">
    <h1 className="text-3xl ml-2 sm:ml-6 md:ml-0 lg:ml-0 md:text-3xl lg:text-4xl xl:text-4xl sm:text-4xl font-bold md:text-left" data-aos="fade-up">
      Discover the best IT <br />
      <span className="relative mt-2 block">
        <span className="text-[#089084]">Strategy For Your Business</span>
      </span>
    </h1>
  </div>
  ...
  <p className="text-lg lg:w-[90%] w-full xl:w-[80%] sm:text-xl sm:text-left pl-2 sm:pl-4 text-gray-700 text-left xl:pl-0 lg:pl-0 md:pl-0 md:text-left" data-aos="fade-up">
    At Devtrain we offer a wide range of tech services such as custom software development, Cloud integration, Mobile/Web development, AI model training, and staff augmentation.
  </p>
