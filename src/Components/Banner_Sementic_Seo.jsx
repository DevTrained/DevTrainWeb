  ...
  >
    ...
    <div className="relative container mx-auto px-4">
      ...
      <nav className="text-sm mb-3 text-gray-200 mt-[17%]  sm:mt-[12%] md:mt-[8%] lg:mt-[8%] xl:mt-[6%]  relative">
        ...
        <span className="ml-2 text-xl"><b>Sementic SEO</b></span>
      </nav>
      
      {/* Main Header Content */}
      <h1 className="text-2xl md:text-3xl font-semibold relative">Sementic SEO</h1>
      <p className="text-sm md:text-lg mt-2 relative">
      "Boost visibility and engagement with targeted, data-driven semantic SEO solutions."
      </p>
    </div>
  </header>   </div>
  )
...
export default Banner_Sementic_Seo