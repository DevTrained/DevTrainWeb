  ...
  return (
    <div className="w-full h-[20vh] sm:h-[40vh] flex justify-center items-center bg-gradient-to-r from-[#175255] to-[#012236] text-white relative font-poppins">
      ...
      >
        ...
        <Link to="/AboutUs" className={`flex items-center mt-2 sm:mt-4 md:mt-4 lg:mt-5 xl:mt-5  justify-center w-8 h-8 sm:w-14 sm:h-14 md:w-14 md:h-14  lg:w-20 lg:h-20 rounded-full bg-[#F7AB0A] transition-all duration-500 ${
