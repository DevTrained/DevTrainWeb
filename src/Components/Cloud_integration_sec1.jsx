...
const VideoSection = () => {
  ...
  <img 
    src="/public/Assets/Images/Cloud_integration.jpeg" 
    alt="AI Consultancy" 
  ...
  <h1 className="text-2xl px-2 sm:text-4xl mt-2 md:text-4xl lg:text-4xl  font-extrabold text-gray-800 ">Cloud Integration Services</h1>
  <p className="text-gray-700 font-medium pt-4 px-3">
  Devtrain.co specializes in seamless cloud integration, enabling businesses to optimize operations, improve scalability, and securely connect applications across platforms.
  We empowers businesses with efficient cloud integration solutions, ensuring smooth data flow and enhanced collaboration across all digital environments.
  </p>
</div>
