...
<section className="flex flex-col md:flex-row items-center justify-between py-12 px-4 bg-[#def2f1] font-poppins ">
      ...
      <img 
    src="/Assets/Images/Web_App_service.jpeg" 
    alt="AI Consultancy" 
  ...
  <h1 className="text-2xl px-2 sm:text-4xl mt-2 md:text-4xl lg:text-4xl  font-extrabold text-gray-800 ">Web Application Development Services</h1>
  <p className="text-gray-700 font-medium pt-4 px-3">
  At Devtrain, we specialize in building robust, scalable web applications tailored to your business needs. From intuitive UI/UX design to secure backend integrations, we deliver seamless, high-performance solutions to elevate your digital presence.
  </p>
</div>
