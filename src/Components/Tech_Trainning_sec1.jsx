...
const VideoSection = () => {
  ...
  return (
    <>
      <motion.section
        className="flex flex-col md:flex-row items-center justify-between py-12 px-4 bg-[#def2f1] font-poppins"
      ...
      >
        ...
        <div className="w-full md:w-1/2 mt-4 md:mt-0 md:pl-8">
          <h1 className="text-2xl px-2 sm:text-4xl mt-2 md:text-4xl lg:text-4xl font-extrabold text-gray-800">
            Tech Trainings Services
          </h1>
