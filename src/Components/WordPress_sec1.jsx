...
const VideoSection = () => {
  ...
  <h1 className="text-2xl px-2 sm:text-4xl mt-2 md:text-4xl lg:text-4xl  font-extrabold text-gray-800 ">WordPress Websites Services</h1>
  <p className="text-gray-700 font-medium pt-4 px-3">
  Devtrain.co delivers expertly crafted WordPress solutions, specializing in creating high-performance static websites that are visually appealing and easy to manage. Our services ensure seamless integration and optimized functionality tailored to enhance your online presence.
  </p>
</div>
